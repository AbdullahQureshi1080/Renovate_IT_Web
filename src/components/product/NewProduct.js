...
const NewProduct = ({onClose}) => {
  ...
  const handleSubmit=async ({productName,productDescription,productPrice,})=>{
    if(!image) return console.log("Upload an Image");
    console.log("In Submit Handler",productName,productDescription,productPrice,image,preview);
